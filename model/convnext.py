...
@register_model
def convnext_tiny(
    expand_ratio=0.125, in_chans=3, pretrained=False, in_22k=False, **kwargs
):
    dims = [int(i * expand_ratio) for i in [128, 256, 512, 1024]]
    # model = ConvNeXt(depths=[3, 3, 9, 3], dims=[96, 192, 384, 768], **kwargs)
    model = ConvNeXt(in_chans=2, depths=[3, 3, 9, 3], dims=dims, **kwargs)
    if pretrained:
        url = (
