...
class Manager():
    ...
    def print_train_info(self):
        ...
        print_str += "l1: %.4f(%.4f) " % (self.loss_status['l1'].val, self.loss_status['l1'].avg)
        print_str += "vgg: %.4f(%.4f) " % (self.loss_status['vgg'].val, self.loss_status['vgg'].avg)
        # print_str += "triplet_loss: %.4f(%.4f) " % (self.loss_status['triplet_loss'].val, self.loss_status['triplet_loss'].avg)
