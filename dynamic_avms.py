...
class DynamicAVMs(object):
    ...
    def match_imgs(self, imgs):
        ...
        warp2 = basenet.warp_image_from_H(homo12, img2, 1, img_h, img_w)
...
if __name__ == '__main__':
    import ipdb
    ipdb.set_trace()
    params = utils.Params('experiments/base_model_r01/params.json')
    davms = DynamicAVMs('experiments/base_model_r01/model_latest.pth', params)

    img1 = cv2.imread('test_datas/000007.jpg')
    img2 = cv2.imread('test_datas/000007_2.jpg')

    warp2, homo12 = davms.match_imgs([img1, img2])
    cv2.imwrite('test_datas/warp.jpg', warp2)
    utils.create_gif([img1, warp2], 'test_datas/000007.gif')
